...
$tableName = 'mk5'; // Default table name
...
<div class="col-md-12 col-12">
    <h1>List Item</h1>
    <p>Manage all hardware in Makmal Komputer 5</p>
</div>
<div class="row">
    <div class="col-md-12">
...
if (isset($_POST['update'])){
    ...
    $status=$_POST['status'];
    $result = mysqli_query($mysqli,"UPDATE mk5 SET item_id='$item_id', item_name='$item_name', status='$status' WHERE item_id='$item_id'") or die (mysqli_connect_error());
    mysqli_close($mysqli);
}
